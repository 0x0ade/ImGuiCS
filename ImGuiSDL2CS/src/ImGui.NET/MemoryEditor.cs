...
namespace ImGuiNET
{
    ...
    public class MemoryEditor
    {
        ...
        public unsafe void Draw(string title, byte[] mem_data, int mem_size, int base_display_addr = 0)
        {
            ...
            ImGuiNative.igSetNextWindowContentSize(new ImVec2(0.0f, line_total_count * line_height));
            ImGui.BeginChild("##scrolling", new ImVec2(0, -ImGuiNative.igGetItemsLineHeightWithSpacing()), false, 0);
